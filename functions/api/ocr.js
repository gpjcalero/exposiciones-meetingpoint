    ...
    body: JSON.stringify({
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Look at this image of product labels or showroom display tags. Extract ALL SAP codes visible in the image. SAP codes are numeric codes, typically 6-10 digits long (e.g. 100336896, 1222347). Return ONLY a valid JSON array of the SAP code strings found, with no explanation. Example output: ["100336896","100412347"]. If no SAP codes are visible, return: []'
          }
        ]
      }]
    })
